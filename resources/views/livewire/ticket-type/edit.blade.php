        ...
        <div class="sm:col-span-4">
          ...
          <div class="mt-1 md:w-1/2 lg:w-2/5">
            <x-form.dropdown label="Department" name="departments" label="Department"
                             model="department">
              <option value="{{ $ticketTypeId->department->id }}" selected>
                {{ $ticketTypeId->department->name }}
              </option>
              @foreach($departments as $department)
                @if($department->id !== $ticketTypeId->department->id)
          ...
          <div class="mt-4">
            ...
            <x-form.radio-container>
              <x-form.radio-btn
                group="status" name="active" value="1" model="status" />
